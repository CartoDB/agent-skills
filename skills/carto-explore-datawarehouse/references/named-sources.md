...
> Named-source CRUD (`carto named-sources create/update/delete`) is **out of scope for this utility skill** — that's part of [`carto-develop-app`](#) (Phase 2). This skill only covers *finding* and *inspecting* existing named sources.
